...
load("data/aciton_orderHistory.rda")
...
#
new_aciton_orderHistory=aciton_orderHistory[,c(1,18:20,4,17,5:13,15,16)]
save(new_aciton_orderHistory, file = "data/new_aciton_orderHistory.rda")
